...
import { addProduct, updateProduct, deleteProduct, updateProductInInvoices } from "../redux/productSlice";
...
const ProductField = () => {
    ...
    const handleAddOrUpdateProduct = () => {
        if(newProduct.productName){
            ...
            if(existingProduct){
                dispatch(updateProductInInvoices({...existingProduct, ...newProduct}));
            } 
            else{
